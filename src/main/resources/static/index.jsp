...
<%@page import="info.business.realestate.projectname.models.ProjectWork"%>
...
<html>
	<head>
		<title>Project Name | Real Estate</title>
						...
						<div class="viewer">
							<div class="reel">
							 ...
							 for(ProjectWork pw : projectWorkList){ %>	
								<div class="slide">
									<img src="${pw.getAttachedImagePath()[0]}" alt="projectImage" />
									<h4>Project Name : "${pw.getProjectName()}"</h4>
								</div>
								<%} %>
								<!-- <div class="slide">
